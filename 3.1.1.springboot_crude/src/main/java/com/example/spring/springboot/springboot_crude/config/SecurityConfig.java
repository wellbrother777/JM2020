package com.example.spring.springboot.springboot_crude.config;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    public SecurityConfig(@Qualifier("myUserDetailsService") UserDetailsService userDetailsService, SuccessHandler successHandler) {
